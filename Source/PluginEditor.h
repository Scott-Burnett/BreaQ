...
public:
    ...
    */
    ...
    const juce::Colour grid1 = juce::Colour::fromRGBA(41, 45, 54, 50); // (0x292d36);
    //const juce::Colour grid2 = juce::Colour(61, 66, 77); // (0x3d424d);
    const juce::Colour grid2 = juce::Colour::fromRGBA(61, 66, 77, 50); // (0x3d424d);
    ...
    const juce::Colour lowPassFillColour = transparentPink;
    const juce::Colour highPassFillColour = transparentCitron;
